...
int main(int argc, char* argv[]) {
    ...
    int tcp_thread = pthread_create(&tcp_accept_thread, NULL, accept_thread_tcp, &tcp_socket);
    int unix_thread = pthread_create(&unix_accept_thread, NULL, accept_thread_unix, &unix_socket);
